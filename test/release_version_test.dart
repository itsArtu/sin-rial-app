...
void main() {
  ...
  test('Installed 2.2 does not offer itself or an older release', () {
    const current = UpdateInfo(version: '2.2.0', build: 64, apkUrl: 'app.apk');
    const previous = UpdateInfo(version: '2.1.13', build: 63, apkUrl: 'old.apk');
    const next = UpdateInfo(version: '2.2.1', build: 65, apkUrl: 'next.apk');
