...
void main() {
  ...
  test('Installed 2.2.2 does not offer itself or an older release', () {
    const current = UpdateInfo(version: '2.2.2', build: 66, apkUrl: 'app.apk');
    const previous = UpdateInfo(version: '2.2.1', build: 65, apkUrl: 'old.apk');
    const next = UpdateInfo(version: '2.2.3', build: 67, apkUrl: 'next.apk');
